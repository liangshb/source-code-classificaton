...
from src.preprocess.codegen.tokenization_utils import process_string


class PythonProcessor(LangProcessor, ABC):
    def __init__(self, root_folder=None):
        ...
        self.char2spetoken = {value: " " + key + " " for key, value in self.spetoken2char.items()}
    ...
    def extract_functions(self, tokenized_code: str):
        ...
        def filter_functions_python_2_3(function):
            if (
                ...
                and re.search(r"raise \w+ ,", function) is None
                and re.search(r"except \w+ ,", function) is None
                and re.search(r"[^ ]+ = \d+ L", function) is None
